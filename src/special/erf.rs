...
mod tests {
    ...
    fn erf_of_very_large_value_should_be_1() {
        assert_relative_eq!(erf(10.0), 1.0, epsilon = 1E-7);
    }
    ...
    fn erf_negative_value_test_1() {
        assert_relative_eq!(erf(-0.25), -0.2763263901682369, epsilon = 1E-6);
    }

    #[test]
    fn erf_negative_value_test_2() {
        assert_relative_eq!(erf(-1.0), -0.84270079294971478, epsilon = 1E-6);
    }

    #[test]
    fn erf_positive_value_test_1() {
        assert_relative_eq!(erf(0.446), 0.47178896844758522, epsilon = 1E-6);
    }
    ...
    fn erfinv_of_zero_should_be_zero() {
        assert_relative_eq!(erfinv(0.0), 0.0, epsilon = 1E-7);
    }

    #[test]
    fn erfinv_positive_value_test_1() {
        assert_relative_eq!(erfinv(0.5), 0.47693627620446982, epsilon = 1E-6);
    }
