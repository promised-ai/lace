...
pub fn single_state_weights(state: &State, col_ixs: &Vec<usize>,
                        given_opt: &Option<Vec<(usize, DType)>>,
...
pub fn single_view_weights(state: &State, target_view_ix: usize,
                       given_opt: &Option<Vec<(usize, DType)>>,
...
// -----------------------
pub fn state_logp(state: &State, col_ixs: &Vec<usize>,
...
pub fn single_val_logp(state: &State, col_ixs: &Vec<usize>, val: &Vec<DType>,
...
pub fn js_uncertainty(states: &Vec<State>, row_ix: usize, col_ix: usize,
