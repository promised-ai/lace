...
mod tests {
    ...
    fn mean() {
        ...
        relative_eq!(bern.mean(), 0.6, epsilon = 10E-8);
    }
    ...
    fn variance() {
        ...
        relative_eq!(bern.var(), 0.3 * 0.7, epsilon = 10E-8);
    }
    ...
    fn like_true_should_be_log_of_p() {
        ...
        relative_eq!(bern1.like(&true), 0.5, epsilon = 10E-8);

        let bern2 = Bernoulli::new(0.95);
        relative_eq!(bern2.like(&true), 0.95, epsilon = 10E-8);
    }
    ...
    fn like_false_should_be_log_of_q() {
        let bern1 = Bernoulli::new(0.5);
        relative_eq!(bern1.like(&false), 0.5, epsilon = 10E-8);

        let bern2 = Bernoulli::new(0.95);
        relative_eq!(bern2.like(&false), 0.05, epsilon = 10E-8);
    }
    ...
    fn loglike_true_should_be_log_of_p() {
        let bern1 = Bernoulli::new(0.5);
        relative_eq!(bern1.loglike(&true), (0.5 as f64).ln(), epsilon = 10E-8);

        let bern2 = Bernoulli::new(0.95);
        relative_eq!(bern2.loglike(&true), (0.95 as f64).ln(), epsilon = 10E-8);
    }
    ...
    fn loglike_false_should_be_log_of_q() {
        let bern1 = Bernoulli::new(0.5);
        relative_eq!(bern1.loglike(&false), (0.5 as f64).ln(), epsilon = 10E-8);

        let bern2 = Bernoulli::new(0.95);
        relative_eq!(bern2.loglike(&false), (0.05 as f64).ln(),
                     epsilon = 10E-8);
    }
}
