use crate::{Datum, FeatureData, SparseContainer};
...
impl TranslateDatum<u32> for lace_consts::rv::dist::Poisson {
...
impl TranslateDatum<u32> for lace_consts::rv::dist::Categorical {
    fn extract(x: Datum) -> u32 {
        match x {
...
impl TranslateDatum<f64> for lace_consts::rv::dist::Gaussian {
...
impl TranslateDatum<bool> for lace_consts::rv::dist::Bernoulli {
...
macro_rules! impl_trainslate_container {
    ($X: ty, $Fx: ident, $variant: ident) => {
        impl TranslateContainer<$X> for lace_consts::rv::dist::$Fx {
            fn extract_container(xs: FeatureData) -> SparseContainer<$X> {
                match xs {
