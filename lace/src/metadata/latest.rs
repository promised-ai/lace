...
use crate::stats::prior_process::{PriorProcess, Process};

use rand_xoshiro::Xoshiro256Plus;
use serde::{Deserialize, Serialize};

use crate::metadata::versions::v1;
use crate::metadata::MetadataVersion;
use crate::{impl_metadata_version, to_from_newtype};
...
impl From<v1::Assignment> for PriorProcess {
    fn from(asgn: v1::Assignment) -> Self {
        Self {
            ...
            process: Process::Dirichlet(
                crate::stats::prior_process::Dirichlet {
                    alpha: asgn.alpha,
